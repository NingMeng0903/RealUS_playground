"""Load helpers for V11 anchored shadow subjects."""
...
def load_chain_retarget_v11_subject(path: Path | str) -> tuple[ChainRestFitSubjectV1, dict[str, Any]]:
    """Load a subject written by ``run_chain_retarget_v11_shadow``."""
...
__all__ = ["load_chain_retarget_v11_subject"]
