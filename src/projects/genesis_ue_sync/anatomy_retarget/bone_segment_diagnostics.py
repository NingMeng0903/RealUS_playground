...
GEOMETRY_LANDMARK_MESHES: dict[str, dict[str, tuple[str, ...]]] = {
    ...
    "wrist_left": {"proximal": ("radius", "ulna"), "distal": ("metacarpal",)},
    "wrist_right": {"proximal": ("radius", "ulna"), "distal": ("metacarpal",)},
    "index_proximal_left": {
        "proximal": ("metacarpal",),
        "distal": ("phalanx_hand", "phalanges_hand"),
    },
    "index_proximal_right": {
        "proximal": ("metacarpal",),
        "distal": ("phalanx_hand", "phalanges_hand"),
