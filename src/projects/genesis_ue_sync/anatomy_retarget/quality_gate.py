...
DEFAULT_LIMITS: dict[str, float] = {
    ...
    "soft_edge_ratio_q99": 1.12,
    "soft_edge_ratio_max": 1.30,
    "tube_graph_ratio_p99": 1.12,
    "tube_graph_ratio_max": 1.30,
    ...
    if material_report is not None:
        ...
        for side in ("left", "right"):
            ...
            if not isinstance(metrics, dict) or not metrics:
                ...
                continue
            if metrics.get("fit_policy") != "ankle_foot_similarity_compound":
                failures.append(f"{side} foot did not use the compound similarity fit")
