...
from .types import CONFIDENCE_FEATURE_VERSION, ContactObservation
...
def confidence_features(image, confidence, config):
    ...
    return dict(**confidence_centroid_from_columns(columns),
...
class FeatureExtractor:
    ...
    def extract(self, image, *, frame_seq, source_id, capture_time_s, received_time_s,
        ...
        obs = ContactObservation(int(frame_seq), str(source_id),
                                 ...
                                 calibration_version=cfg.calibration_version, **centroid)
        return obs, c
