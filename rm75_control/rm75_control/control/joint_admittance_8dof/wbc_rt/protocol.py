...
WBC_IN_DTYPE = np.dtype(
    [
        ...
        ("cmd_u", "<u4", (8,)),
        ("rail_refresh_dt", "<f8"),
        ("rocking_axis_base", "<f8", (3,)),
        ("rocking_bounds", "<f8", (6,)),
        ("rocking_enabled", "<u4"),
        ("command_power_wrench_base", "<f8", (6,)),
        ("command_power_min_w", "<f8"),
        ("command_power_enabled", "<u4"),
        ("command_twist_rows_base", "<f8", (16, 6)),
        ("command_twist_lower", "<f8", (16,)),
        ("command_twist_upper", "<f8", (16,)),
        ("command_twist_count", "<u4"),
    ],
    align=False,
)
...
WBC_OUT_DTYPE = np.dtype(
    [
        ...
        ("qp_total_ms", "<f8"),
        ("ipc_wait_ms", "<f8"),
        ("rocking_policy_tier", "<u4"),
        ("rocking_limited", "<u4"),
        ("rocking_lower_rad_s", "<f8"),
        ("rocking_upper_rad_s", "<f8"),
...
assert WBC_IN_SIZE == 1780, WBC_IN_SIZE
assert WBC_OUT_SIZE == 1496, WBC_OUT_SIZE
