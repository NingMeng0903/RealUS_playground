...
def dump_wbc_config(
    ...
    *,
    ...
    lines = [
        ...
        f"rail_allocator.posture_gate.enabled {int(bool(getattr(getattr(ra, 'posture_gate', None), 'enabled', True)))}",
        f"rail_allocator.posture_gate.enter_ratio {_f(getattr(getattr(ra, 'posture_gate', None), 'enter_ratio', 0.50))}",
        f"rail_allocator.posture_gate.exit_ratio {_f(getattr(getattr(ra, 'posture_gate', None), 'exit_ratio', 0.35))}",
        f"rail_allocator.posture_gate.enter_speed_m_s {_f(getattr(getattr(ra, 'posture_gate', None), 'enter_speed_m_s', 0.010))}",
        f"rail_allocator.posture_gate.exit_speed_m_s {_f(getattr(getattr(ra, 'posture_gate', None), 'exit_speed_m_s', 0.005))}",
        f"rail_allocator.posture_gate.enter_dwell_s {_f(getattr(getattr(ra, 'posture_gate', None), 'enter_dwell_s', 0.050))}",
        f"rail_allocator.posture_gate.exit_dwell_s {_f(getattr(getattr(ra, 'posture_gate', None), 'exit_dwell_s', 0.100))}",
        f"rail_allocator.posture_gate.open_tau_s {_f(getattr(getattr(ra, 'posture_gate', None), 'open_tau_s', 0.150))}",
        f"rail_allocator.posture_gate.close_tau_s {_f(getattr(getattr(ra, 'posture_gate', None), 'close_tau_s', 0.100))}",
