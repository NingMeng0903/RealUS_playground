...
def dump_wbc_config(
    ...
    *,
    ...
    lines = [
        ...
        f"nullspace.homotopy_fade_s {_f(getattr(ns, 'homotopy_fade_s', 0.6))}",
        ...
        f"psi_retarget.d_center_accel_m_s2 {_f(getattr(pr, 'd_center_accel_m_s2', 0.06))}",
        f"psi_retarget.psi_rate_rad_s {_f(getattr(pr, 'psi_rate_rad_s', 0.4))}",
        f"psi_retarget.psi_accel_rad_s2 {_f(getattr(pr, 'psi_accel_rad_s2', 1.0471975511965976))}",
        f"psi_retarget.homotopy_ramp_s {_f(getattr(pr, 'homotopy_ramp_s', 0.35))}",
