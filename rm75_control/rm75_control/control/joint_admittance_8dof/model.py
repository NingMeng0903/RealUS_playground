...
class RobotKinematics:
    ...
    def __init__(
        ...
        self._urdf_tcp_offset_pose = self._read_tcp_offset_pose()
        self._tcp_offset_pose = self._urdf_tcp_offset_pose.copy()
    ...
    @property
    def urdf_tcp_offset_pose(self) -> np.ndarray:
        return np.asarray(self._urdf_tcp_offset_pose, dtype=float).copy()
