...
def build_gamepad_vcmd_program(
    ...
    *,
    ...
    twist_cfg = GamepadTwistConfig(
        ...
        trans_j_max_m_s3=float(getattr(params, "gamepad_trans_j_max_m_s3", 8.0)),
        rot_j_max_rad_s3=float(getattr(params, "gamepad_rot_j_max_rad_s3", 16.0)),
        pad_lpf_hz=float(getattr(params, "gamepad_pad_lpf_hz", 16.0)),
