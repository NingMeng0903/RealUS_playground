...
These tests pin the desired cost hierarchy of the WBC slack QP:
    ...
    W_task (100) >> scheduled rail task (normally <= 6)
                 >> reg (~1e-2)
...
# the minimal invariant we need — production uses W_task=100 versus a rail
# scheduler around 6 at deep sigma. If that ever inverts (bugs
