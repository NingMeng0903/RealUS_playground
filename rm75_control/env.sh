...
export RM75_PLAYGROUND="/media/camp/EXT_DRIVE/RealUS_playground"
...
export PYTHONPATH="${RM75_PLAYGROUND}:${RM75_CONTROL_ROOT}:${RM_API2_PYTHON}:${RM75_CMEEL_SITELIB}:${PYTHONPATH:-}"
