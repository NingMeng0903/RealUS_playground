...
Colors: after copy, retune Collada diffuse to match the probe color palette
(converter / blue parts → soft blue).

Run:
  /media/camp/EXT_DRIVE/blender/blender --background --python \\
    scripts/export_probe45_meshes.py
"""
...
if __name__ == "__main__":
    try:
        ...
        print(f"export_probe45_meshes failed: {exc}", file=sys.stderr)
        raise
