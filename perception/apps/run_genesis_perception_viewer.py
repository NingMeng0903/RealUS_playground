...
def main() -> int:
    ...
    ap.add_argument(
        ...
        action="store_true",
        help="Debug only: draw limb_vessel_planning tube/point overlays (off by default)",
    )
    ap.add_argument(
        "--planning-root",
        type=Path,
    ...
    planning_root = None
    if args.show_vessel_planning:
        planning_root = args.planning_root or Path("outputs/anatomy_retarget/limb_vessel_planning")
