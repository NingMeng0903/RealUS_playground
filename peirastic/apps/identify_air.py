    ...
    rows = [
        {
            ...
            "identified": f"{t0:.6f}",
            "unit": "s",
            "yaml_now": "shield.plant.t0_s=0.035; system_delay_s=0.055; barrier.t_react_s=0.055; cdyob.t0_s=0.030",
            "consume": "use T0=0.035 as the delay centre; do not bake 0.055 into certificates",
        ...
        },
        {
            ...
            "identified": f"{tp:.6f}",
            "unit": "s",
            "yaml_now": "shield.plant.tp_s=0.012; cdyob.tp_s=0.012",
            "consume": "0.012",
            "note": "chirp median",
        },
        {
        ...
        },
        {
            ...
            "unit": "N/m",
            "yaml_now": "ke_initial=80; ke_cap_ub=2000; k_ub=8000",
